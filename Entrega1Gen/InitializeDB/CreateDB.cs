...
public static void InitializeData ()
{
        ...
        try
        {
                ...
                int idLibro3 = PagoCEN.New_ (libro3EN.Titulo, libro3EN.Portada, libro3EN.Descripcion, libro3EN.Fecha, libro3EN.Publicado, usu1, listaCategorias, libro3EN.Baneado, libro3EN.Num_denuncias, 0, 0, libro3EN.EnRevision, 9, false);
                int idLibro4 = PagoCEN.New_ (libro4EN.Titulo, libro4EN.Portada, libro4EN.Descripcion, libro4EN.Fecha, libro4EN.Publicado, usu3, listaCategorias2, libro4EN.Baneado, libro4EN.Num_denuncias, 0, 0, libro4EN.EnRevision, 9, false);
                ...
                capituloCEN.Redactar ("Lorem ipsum dolor sit amet", cap2);

                System.Console.WriteLine ("Contenido del capitulo 2 despues con lorem ipsum: " + capituloCEN.VerCapitulo (cap2).Contenido);
